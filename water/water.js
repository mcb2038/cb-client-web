...
/* 
Utility method 1:
Iterates over water sources array, passing each water source object to Utility method 2. 
Method 2 returns `li` DOM nodes, which are then appended to the list we created in water.html.
*/
